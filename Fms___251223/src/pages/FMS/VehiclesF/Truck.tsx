                                ...
                                {filteredItems.map((contact: any) => {
                                    return (
                                        <tr key={contact.id}>
                                            ...
                                            <td className="whitespace-nowrap">{contact.TruckExpiryDate ? new Date(contact.TruckExpiryDate).toISOString().split('T')[0].split('-').reverse().join('-') : ""}</td>
                                            <td>
                                ...
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="p-5">
                                        <form>
                                            ...
                                            <div className="mt-4">
                                                <label htmlFor="capacityTons">capacityTons</label>
                                                <input
                                                    id="capacityTons"
                                                    name="capacityTons"
                                                    value={params.capacityTons}
                                                    type="text"
                                                    placeholder="Enter capacityTons"
                                                    className="form-input"
                                                    required
                                                    onChange={(e) => changeValue(e)}
                                                />
                                            ...
                                            <div className="mt-4">
                                                <label htmlFor="TruckDocument">TruckDocument</label>
                                                <input
                                                    id="TruckDocument"
                                                    name="TruckDocument"
                                                    value={params.TruckDocument}
                                                    type="file"
                                                    placeholder="Enter TruckDocument"
                                                    className="form-input"
                                                    required
                                                    onChange={(e) => changeValue(e)}
                                                />
