...
const Customer = () => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        citys2: Yup.string(),
        state2: Yup.string(),
        postal_code2: Yup.number().typeError('Postal code must be a number'),
        country2: Yup.string(),
                                        ...
                                        <form onSubmit={formik.handleSubmit}>
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className={`${inputStyle} ${formik.touched.company_name && formik.errors.company_name ? 'border-red-500' : 'border-gray-300'}`}
                                            ...
                                            <div>
                                                ...
                                                {formik.touched.contact_person && formik.errors.contact_person && (
                                                    <div style={{ color: 'red' }}>{formik.errors.contact_person}</div>
                                                )}
                                            </div>
                                            ...
                                            <div className="mb-4">
                                                ...
                                                />
                                                {formik.touched.Tax_reg_no && formik.errors.Tax_reg_no && (
                                                    <div style={{ color: 'red' }}>{formik.errors.Tax_reg_no}</div>
                                                )}
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                />
                                                {formik.touched.citys && formik.errors.citys && (
                                                    <div style={{ color: 'red' }}>{formik.errors.citys}</div>
                                                )}
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                {formik.touched.postal_code && formik.errors.postal_code && (
                                                    <div style={{ color: 'red' }}>{formik.errors.postal_code}</div>
                                                )}
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                />
                                                {formik.touched.citys2 && formik.errors.citys2 && (
                                                    <div style={{ color: 'red' }}>{formik.errors.citys2}</div>
                                                )}
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                />
                                                {formik.touched.state2 && formik.errors.state2 && (
                                                    <div style={{ color: 'red' }}>{formik.errors.state2}</div>
                                                )}
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                />
                                                {formik.touched.postal_code2 && formik.errors.postal_code2 && (
                                                    <div style={{ color: 'red' }}>{formik.errors.postal_code2}</div>
                                                )}
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                {formik.touched.country2 && formik.errors.country2 && (
                                                    <div style={{ color: 'red' }}>{formik.errors.country2}</div>
                                                )}
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                {formik.touched.credit_limit && formik.errors.credit_limit && (
                                                    <div style={{ color: 'red' }}>{formik.errors.credit_limit}</div>
                                                )}
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                {formik.touched.balance && formik.errors.balance && (
                                                    <div style={{ color: 'red' }}>{formik.errors.balance}</div>
                                                )}
                                            </div>
