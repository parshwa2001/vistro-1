...
const Client = () => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        postal_code2: Yup.string().required('Postal Code 2 is required'),
                        ...
                        <div className="flex min-h-full items-center justify-center px-4 py-8">
                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="p-5">
                                        <form onSubmit={formik.handleSubmit} className="max-w-xl mx-auto p-4 bg-white border border-gray-300 rounded-md shadow-md">
                                            {/* Company Name */}
                                            <div className="mb-4">
                                            ...
                                            {/* Contact Person */}
                                            <div className="mb-4">
                                                <label htmlFor="contact_person" className="block text-sm font-medium text-gray-600">
                                                    Contact Person
                                                </label>
                                                <input
                                                    type="text"
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.contact_person && formik.errors.contact_person ? 'border-red-500' : ''}`}
                                                />
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <input
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.phone_number && formik.errors.phone_number ? 'border-red-500' : ''}`}
                                                />
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <input
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.address && formik.errors.address ? 'border-red-500' : ''}`}
                                                />
                                            ...
                                            {/* City */}
                                            <div className="mb-4">
                                                <label htmlFor="citys" className="block text-sm font-medium text-gray-600">
                                                    City
                                                </label>
                                                <input
                                                    type="text"
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.citys && formik.errors.citys ? 'border-red-500' : ''}`}
                                                />
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <input
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.state && formik.errors.state ? 'border-red-500' : ''}`}
                                                />
                                            ...
                                            {/* Postal Code */}
                                            <div className="mb-4">
                                                <label htmlFor="postal_code" className="block text-sm font-medium text-gray-600">
                                                    Postal Code
                                                </label>
                                                <input
                                                    type="text"
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.postal_code && formik.errors.postal_code ? 'border-red-500' : ''}`}
                                                />
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <input
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.country && formik.errors.country ? 'border-red-500' : ''}`}
                                                />
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <input
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.address2 && formik.errors.address2 ? 'border-red-500' : ''}`}
                                                />
                                            ...
                                            {/* City 2 */}
                                            <div className="mb-4">
                                                <label htmlFor="city2" className="block text-sm font-medium text-gray-600">
                                                    City 2
                                                </label>
                                                <input
                                                    type="text"
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.city2 && formik.errors.city2 ? 'border-red-500' : ''}`}
                                                />
                                            ...
                                            {/* State 2 */}
                                            <div className="mb-4">
                                                <label htmlFor="state2" className="block text-sm font-medium text-gray-600">
                                                    State 2
                                                </label>
                                                <input
                                                    type="text"
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.state2 && formik.errors.state2 ? 'border-red-500' : ''}`}
                                                />
                                            ...
                                            {/* Postal Code 2 */}
                                            <div className="mb-4">
                                                <label htmlFor="postal_code2" className="block text-sm font-medium text-gray-600">
                                                    Postal Code 2
                                                </label>
                                                <input
                                                    type="text"
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.postal_code2 && formik.errors.postal_code2 ? 'border-red-500' : ''}`}
                                                />
                                            ...
                                            {/* Country 2 */}
                                            <div className="mb-4">
                                                <label htmlFor="country2" className="block text-sm font-medium text-gray-600">
                                                    Country 2
                                                </label>
                                                <input
                                                    type="text"
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.country2 && formik.errors.country2 ? 'border-red-500' : ''}`}
                                                />
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <input
                                                    ...
                                                    className={`mt-1 p-2 w-full border rounded-md ${formik.touched.username && formik.errors.username ? 'border-red-500' : ''}`}
                                                />
