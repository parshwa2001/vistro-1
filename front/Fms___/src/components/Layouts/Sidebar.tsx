                ...
                <div className="bg-white dark:bg-black h-full">
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            {/* Client */}
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'client' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('client')}>
                                    <div className="flex items-center">
                                        <IconMenuPages className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('client')}</span>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'client' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/client/client">{t('Client')}</NavLink>
                                        </li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'transaction' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <NavLink to="/transaction/invoice" >
                                                {t('Invoice Receipt')}
                                            </NavLink>
                                        </li>
