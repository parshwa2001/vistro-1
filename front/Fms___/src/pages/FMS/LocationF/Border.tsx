                                    ...
                                    <div className="p-5">
                                        <form>
                                            ...
                                            <div className="mt-4">
                                                ...
                                                <select id="ctnSelect" name="country_id" onChange={(e) => changeValue(e)} value={params.country_id} className="form-select text-white-dark" required>
                                            ...
                                            <div className="mt-4">
                                                <label htmlFor="ctnSelect">Select Country</label>
                                                <select id="ctnSelect" name="type" onChange={(e) => changeValue(e)} value={params.type} className="form-select text-white-dark" required>
                                                    <option>Select Country</option>
