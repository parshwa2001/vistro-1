                                    ...
                                    <div className="p-5">
                                        <form>
                                            <div>
                                                ...
                                                <select id="ctnSelect4" name="country_id" onChange={(e) => changeValue(e)} value={params.country_id} className="form-select text-white-dark" required>
                                            ...
                                            {!viewContactModal && (
                                                <div className="flex justify-end items-center mt-8">
                                                    ...
                                                    <button type="button" className="btn btn-danger ltr:ml-4 rtl:mr-4" onClick={saveUser}>
                                                        Reset
                                                    </button>
                                                </div>
