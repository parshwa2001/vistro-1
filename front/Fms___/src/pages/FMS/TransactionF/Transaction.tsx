                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                                        {params.client ? 'Edit Tracking' : 'Add Transaction'}
                                    </div>
                                    <div className="p-5">
                                        <form>
                                            <div>
                                            ...
                                            <div className="mt-4">
                                                <div>
                                                    ...
                                                    <select name="mode" onChange={(e) => changeValue(e)} value={params.mode} className="form-select text-white-dark" required>
                                            ...
                                            <div className="mt-4">
                                                <div>
                                                    <label htmlFor="routename">Payable Ammount</label>
                                                    <input
                                                        id="routename"
                                                        type="number"
                                                        name="payable_ammount"
                                                        onChange={(e) => changeValue(e)}
                                                        value={params.payable_ammount}
                                            ...
                                            <div className="mt-4">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder="Enter Ammount Pay To Driver"
                                                        className="form-input"
                                                        required
                                                    />
                                                </div>
