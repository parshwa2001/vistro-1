                                    ...
                                    <div className="p-5">
                                        <form onSubmit={formik.handleSubmit}>
                                            <div>
                                                ...
                                                />
                                                {formik.touched.company_name && formik.errors.company_name && <div style={{ color: 'red' }}>{formik.errors.company_name}</div>}
                                            </div>
                                            ...
                                            <div className='mt-4'>
                                                ...
                                                />
                                                {formik.touched.contact_person && formik.errors.contact_person && <div style={{ color: 'red' }}>{formik.errors.contact_person}</div>}
                                            </div>
                                            ...
                                            <div className="mt-4">
                                                ...
                                                />
                                                {formik.touched.Tax_reg_no && formik.errors.Tax_reg_no && <div style={{ color: 'red' }}>{formik.errors.Tax_reg_no}</div>}
                                            </div>
                                            ...
                                            <div className='mt-4'>
                                                ...
                                                />
                                                {formik.touched.address2 && formik.errors.address2 && <div style={{ color: 'red' }}>{formik.errors.address2}</div>}
                                            </div>
                                            <div className="grid mt-4 grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div className='mt-4'>
                                                ...
                                                />
                                                {formik.touched.credit_limit && formik.errors.credit_limit && <div style={{ color: 'red' }}>{formik.errors.credit_limit}</div>}
                                            </div>
                                            ...
                                            <div className='mt-4'>
                                                ...
                                                />
                                                {formik.touched.balance && formik.errors.balance && <div style={{ color: 'red' }}>{formik.errors.balance}</div>}
                                            </div>
