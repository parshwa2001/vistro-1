                                        ...
                                        <form>
                                            ...
                                            <div className="grid mt-4 grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <select name="client" onChange={(e) => changeValue(e)} value={params.client} className="form-select text-white-dark" required>
                                                ...
                                                <div>
                                                    ...
                                                    <select name="driver" onChange={(e) => changeValue(e)} value={params.driver} className="form-select text-white-dark" required>
                                            ...
                                            <div className="grid mt-4 grid-cols-1 sm:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    <label htmlFor="routename">Select Route Fare</label>
                                                    <input
                                                        id="booking_id"
                                                        name="route_fare"
                                                        onChange={(e) => changeValue(e)}
                                            ...
                                            <div className="mt-4">
                                                <label htmlFor="routename">Select Border Fare</label>
                                                <input
                                                    id="border_fare"
